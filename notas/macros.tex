...
%%%% Norms
\newcommand{\tracenorm}[1]{\| #1 \|_{1}}
\newcommand{\diamondnorm}[1]{\| #1 \|_{\diamondsuit}}
\newcommand{\lonenorm}[1]{\| #1  \|_{ L^{1} }}
\newcommand{\gentracenorm}[1]{\| #1  \|_{ L^\infty }}
\newcommand{\gendiamondnorm}[1]{\| #1 \|_{ \diamondsuit \text{ gen}}}
