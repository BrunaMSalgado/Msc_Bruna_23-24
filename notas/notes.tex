...
\begin{lemma} \label{lemma:uv*_tensorI_gen}
  Let $\phi_i: \mathcal{M}_{n}  \rightarrow \sigma$ be a super-operator.  For every choice of a complex vector space $\mathbb{C}^{m}$ and unit vectors $v_1, v_2 \in \mathbb{C}^{n} \otimes \mathbb{C}^{m}$, there exist unit vectors $w_1, w_2 \in \mathbb{C}^{n} \otimes \mathbb{C}^{n}$ such that the following equalities hold:
  \begin{align*} 
...
\end{proof}
 ...
 \begin{theorem} \label{theorem:tensor_stability} 
  ...
  \begin{equation*}
    \gentracenorm{\phi \otimes \id_{\mu}} =  \gendiamondnorm{\phi}
  \end{equation*}
  ...
  \begin{align*}
    \gendiamondnorm{\phi \otimes \id_{\mu}} =  \gendiamondnorm{\phi}
\end{align*}
  \end{corollary}


  \begin{proposition}\label{lem:gen_trace_submultiplicative}
    Let $\sigma: n_1, \ldots, n_s$, $\tau: m_1, \ldots, m_t$ and $\mu: o_1, \ldots, o_r$ be signatures.  For all super-operators $\phi: \sigma  \rightarrow \tau$ and $\psi: \tau  \rightarrow \mu$, it holds that:
    \begin{align*} 
