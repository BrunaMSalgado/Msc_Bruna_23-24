...
\begin{proof}
  ...
  restriction of $(\phi \odot_\varepsilon \psi)^*$ \cite{Cho2014}. Consequently, it follows that $ \cbnorm{\phi_* \odot_\varepsilon \phi_*} \leq \cbnorm{(\phi \odot_\varepsilon \psi)_*}$ and therefore, $ \cbnorm{\phi^*  \,\widecheck{\otimes}_\varepsilon \phi^*} \leq \cbnorm{(\phi  \,\widecheck{\otimes}_\varepsilon \psi)^*}$. As a result, attending to Proposition \ref{prop:cb_dual} it holds that 
