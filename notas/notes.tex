...
%We start by proving that $\BHCPSUop$ is a $\catMet$-enriched symmetric monoidal category with coproducts.
...
\todo[inline]{Ver quais os conceitos de w* algebras são essenciais e acrescentar, def c* algebra,w* algebra, predual,ultraweak topololy, tensor product for W* algebras e props relevantes, dualidade trace class, BH }
...
Another, and, perhaps more useful way, to describe this relashion is given by the diagram bellow 
