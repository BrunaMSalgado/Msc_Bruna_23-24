...
\todo[inline]{perceber se o que está na tese do Abraham Anton Westerbaan coincide com o que está abaixo}
...
\begin{proof}
  p.115 da tese Abraham Anton Westerbaan -> Podemos inferir que $\norm{\phi \, \bar{\otimes} \, \psi} =  \norm{f} \cdot \norm{g} $?
