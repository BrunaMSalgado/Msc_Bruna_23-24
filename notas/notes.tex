...
Regarding the interpretation of the coproduct, the type $A \oplus B$ is interpreted as $[\![A \oplus B ]\!] = [\![A ]\!] \oplus [\![ B ]\!] $. Considering...
\todo[inline,size=\normalsize]{Explicar o que é dits} 
