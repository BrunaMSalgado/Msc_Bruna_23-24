...
\begin{proof}[Proof sketch]
        The proof piggybacks on the one in~\cite{dahlqvist22,dahlqvist2023syntactic},
        specifically we need to focus only on the cases involving additive disjunction.
        The soundness part uses the linear and Cartesian enrichment as well as the
        definition of a $\mathcal{V}$-category.
