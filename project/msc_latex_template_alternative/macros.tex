...
\newcommand{\tr}{\text{Tr}}
\newcommand{\HilbH}{\mathcal{H}}
\newcommand{\HilbK}{\mathcal{K}}
\newcommand{\HilbL}{\mathcal{L}}
\newcommand{\BoundOp}[1]{\mathcal{B}(#1)}
\newcommand{\TraceOp}[1]{\mathcal{T}(#1)}
\newcommand{\SqMatrix}[1]{\mathcal{M}_{#1}}
\newcommand{\MnMatrix}[1]{\mathcal{M}_{n}(#1)}
...
\newcommand{\wcbnorm}[1]{\left\lVert #1  \right\rVert_{\text{cb$w^*$}}}
\newcommand{\projnorm}[1]{\left\lVert #1  \right\rVert_{\pi}}
\newcommand{\minnorm}[1]{\left\lVert #1  \right\rVert_{min}}
\newcommand{\wnorm}[1]{\left\lVert #1  \right\rVert_{\text{$w^*$}}}
%%%% Tensor
\newcommand{\projtensor}{\widehat{\otimes}_\pi}

\newcommand{\Measu}{\sfunfont{M}}

\newcommand{\Kar}[1]{\mathcal{K}{(#1)}}
