...
\begin{equation}
  \begin{split}
  \|Q\|_{1 \text{ gen}} & = \max  \Bigg\{ \max \left\{ \sum_{i=1}^{m} \|Q_{1i} (v_1)\|_{1}   \mid \hspace{1pt} \|v_1\|_{1} = 1 \right\} \\
  & \hspace{15pt} ,\hspace{2pt}  \ldots \hspace{2pt}  , \max \left\{ \sum_{i=1}^{m} \|Q_{ni} (v_n)\|_{1}   \mid \|v_n\|_{1} = 1 \right\} \Bigg\} 
  \end{split}
\end{equation}
\end{definition}
...
\begin{equation}
  \begin{split}
    \|Q\|_{\diamondsuit \text{ gen}} & =  \max  \Bigg\{ \max \left\{ \sum_{i=1}^{m} \|Q_{1i} \otimes I_{\mathbb{C}^{o_1 \times o_1}} (v_1)\|_{1}    \mid  \|v_1\|_{1} = 1 \right\} \\
    & \hspace{15pt}, \hspace{2pt} \ldots \hspace{2pt}, \left\{ \sum_{i=1}^{m} \|Q_{ni} \otimes I_{\mathbb{C}^{o_n \times o_n}} (v_n)\|_{1}    \mid  \|v_n\|_{1} = 1 \right\} \Bigg\} 
  \end{split}
\end{equation}
\end{definition} 
