...
It follows that,
  \begin{equation} \label{eq:teleport_T_part2}
   ...
   & + \Big(\Big(\frac{1}{4} XZ|\psi\rangle \langle \psi|ZX, \frac{1}{4} Z|\psi\rangle \langle \psi|Z\Big),\Big(\frac{1}{4} X|\psi\rangle \langle \psi|X, \frac{1}{4}  |\psi\rangle \langle \psi| \Big)\Big) \Big) \\    
    \end{split}
  \end{equation}
Next, regarding the condicional statements, taking into account that applying correction to $\Big(\Big(\frac{1}{4} |\psi\rangle \langle \psi|, \frac{1}{4} X|\psi\rangle \langle \psi|X\Big),\Big(\frac{1}{4} Z|\psi\rangle \langle \psi|Z, \frac{1}{4}  XZ|\psi\rangle \langle \psi|ZX \Big)\Big) $ results in the state $\ket{\psi}$ (\autoref{eq:teleport_correction}), and moreover, %resto dos estados
