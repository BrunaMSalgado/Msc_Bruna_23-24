...
%relative order of the variables in $\Gamma_i$ is preserved, 
  ...
  \begin{figure} [H]
    ...
    $\begin{array}{c}
      ...
      \\
      \hline
      E \triangleright \text{ case } v \hspace{2pt} \{\text{inl}_{\mathbb{B}} (x) \Rightarrow w[a/z] ; \hspace{1pt} \text{inr}_{\mathbb{A}} (y) \Rightarrow u[a/z]\}: \mathbb{C}
      \\
      \hline
      E  \triangleright \text{ case } v \hspace{2pt} \{\text{inl}_{\mathbb{B}}  (x) \Rightarrow w ; \hspace{1pt} \text{inr}_{\mathbb{A}}  (y) \Rightarrow u\}[a/z]: \mathbb{C}
    \end{array}
    $
    \end{minipage}
    \end{aligned}
...
\begin{figure} [H]
  ...
  $\begin{array}{c}
    ...
    \\
    \hline
    E \triangleright \text{ case } v[a/z] \hspace{2pt} \{\text{inl}_{\mathbb{B}} (x) \Rightarrow w ; \hspace{1pt} \text{inr}_{\mathbb{A}} (y) \Rightarrow u\}: \mathbb{C}
    \\
    \hline
    E  \triangleright \text{ case } v \hspace{2pt} \{\text{inl}_{\mathbb{B}}  (x) \Rightarrow w ; \hspace{1pt} \text{inr}_{\mathbb{A}}  (y) \Rightarrow u\}[a/z]: \mathbb{C}
  \end{array}
...
And as a result, one has that $... \text{dist} = \text{id} \otimes \text{id}$. Therefore,
