...
2 and 3 imply that if $\Delta \simeq_{\pi} \Delta $, then $\mathbb{C}=\mathbb{C}'$. "If $\Gamma,\Delta \simeq_{\pi} \Delta $, then $\mathbb{C}=\mathbb{C}'$ ",  also implies that if $\Delta \simeq_{\pi} \Gamma', \Delta' $, then $\mathbb{C}=\mathbb{C}'$. Moreover, given that $E \in \text{Sf}(\Gamma;\Delta)$ and  $E' \in \text{Sf}(\Gamma';\Delta')$, it follows that $\Gamma, \Delta \simeq_{\pi} \Gamma', \Delta'$. Consequently, $E \simeq_{\pi} E' $, then $\mathbb{C}$ must be equal to $\mathbb{C}'$.
