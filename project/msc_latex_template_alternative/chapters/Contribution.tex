...
Regarding the interpretation of the quantum teleportation protocol, the state of the qubit to be teleported before measurement is calculated as follows,
\begin{equation}
  \begin{split}
...
\xmapsto{I \hspace{1pt} \otimes \hspace{1pt} CNOT} \quad & ( \alpha|0\rangle + \beta|1\rangle) \otimes \frac{1}{\sqrt{2}} (|00\rangle + |11\rangle ) = \frac{1}{\sqrt{2}} (\alpha|000\rangle + \alpha|011\rangle + \beta|110\rangle + \beta|101\rangle)\\
 \xmapsto[]{H \otimes I \otimes I} \quad & \frac{1}{\sqrt{2}} (\alpha |000\rangle +\alpha |001\rangle +  \alpha|011\rangle + \alpha|111\rangle + \beta )  \\
  \end{split}
\end{equation}
