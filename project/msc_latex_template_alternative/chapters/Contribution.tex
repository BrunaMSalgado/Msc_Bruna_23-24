...
Now, consider a malicious attack on the quantum teleportation protocol that consists of a bit-flip with 50\% probability before measurement.  The operation of fliping a bit with 50\% probability can be concieved as the composition $I otimes \text{disc} \cdot $
...
\begin{figure} [H]
  ...
  \begin{quantikz} [column sep=0.2cm, row sep=0.5cm,wire
    types={n,n,n,n,n}]%
      ...
      xsep=2pt},background,label style={label
      position=below,anchor=north,yshift=-0.2cm}]{{\sc
      B}} & \gate{H} \qw & \qw & \qw &\qw \gategroup[5,steps=16,style={dashed,rounded
      corners,fill=blue!20, inner
      xsep=2pt},background,label style={label
      position=below,anchor=north,yshift=-0.2cm}]{{\sc
      C}}  & \qw & \qw & \qw & \targ{} \qw  & \qw & \qw & \qw & \qw  & \meter{} \qw      & \setwiretype{c}  &  &  & & \ctrl[vertical
wire=c]{2}  \\
      \lstick {$\ket{0}$}  &\gate{H}\gategroup[2,steps=3,style={dashed,rounded
      corners,fill=blue!20, inner
      xsep=2pt},background,label style={label
      position=below,anchor=north,yshift=-0.2cm}]{{\sc
      A}} & \qw  & \ctrl{1} \qw& \qw & \qw  & \targ{} \qw & \qw & \qw & \qw & \qw& \qw & \qw & \qw & \qw &  \qw & \qw &  \targ{} \qw & \qw &   \meter{} \qw & \setwiretype{c}  & & \ctrl[vertical
wire=c]{1} \\
      \lstick{$\ket{0}$}  &  \qw & \qw &  \targ{} \qw \qw & \qw &\qw&\qw & \qw & \qw& \qw & \qw & \qw & \qw& \qw & \qw & \qw & \qw &  \qw & \qw & \qw & \qw & \qw &  \gate{X} \qw & \qw & \gate{Z} \qw\\
