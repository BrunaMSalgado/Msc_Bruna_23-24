...
\autoref{bennett1993teleporting} introduced the concept of quantum teleportation, which is a protocol that allows the transfer of quantum information from one qubit to another. The protocol is based on the entanglement of two qubits and the transmission of two classical bits. The quantum teleportation protocol is a fundamental building block for quantum communication and quantum computation.
