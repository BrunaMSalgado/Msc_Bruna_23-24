...
\begin{equation}
  \|Q\|_{1 \text{ gen}} = \max \{ \|Q_1 (A_1)\|_{1 \text{ gen}}  \mid  \|A_1\|_{1} = 1, \hspace{2pt}\ldots \hspace{2pt}, \|Q_n (A_n)\|_{1 \text{ gen}}  \mid  \|A_n\|_{1} = 1  \}
\end{equation}
\end{definition}
...
\begin{lemma}\label{thm:Russo–Dye}
  ...
  \begin{equation}
    \lVert Q_i \rVert_{1 \text{ gen}}  = \max \{ \text{Tr}\left(Q_i(vv^{*}) \right) \mid \lVert v \rVert_{1}=1 \} 
  \end{equation}
\end{lemma}
...
For $A \in \mathbb{C}^{n \times n}$, it holds that:
  ...
  &\hspace{-30pt} \lVert Q_i \rVert_{1 \text{ gen}}  = \max \left\{ \sum_{j=1}^{m}\max \{ \lVert Q_{ij}(A) \rVert_{1} \Biggm|  \lVert A \rVert_{1} =1  \} \right\}   & \{\text{\autoref{def:gen_norm_gen_inj}} \} \notag\\
  & \hspace{-30pt}= \max \left\{ \sum_{j=1}^{m} \lVert Q_{ij}(A) \rVert_{1}   \Biggm| \lVert A \rVert_{1} =1 \right\} & \{\text{\autoref{lemma:max_max}}\} \notag \\
...
&  \hspace{-30pt} =  \max \left\{  \left| \left\langle A, \sum_{j=1}^{m} Q_{ij}^{\dag}U_j \right\rangle \right|  \Biggm| \lVert A \rVert_{1} =1,  U_j \in \mathbb{C}^{n \times n} \right\}
\end{align} 
...
Attending to \autoref{thm:Russo–Dye}, \autoref{eq:qi_norm} can be rewritten as:
\begin{align} 
