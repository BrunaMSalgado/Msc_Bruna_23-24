...
\begin{definition} \label{def:gen_norm_gen_inj}
  ...
  \begin{equation}
    \|Q\|_{\{V \rightarrow W_1,\ldots ,V \rightarrow W_n\} \text{ gen}} = \max \left\{ \sum_{i=1}^{m}  \| Q_{i} (v)\|_{W_i}  \vert \hspace{1pt} \|v\|_{V} = 1 \right\}
  \end{equation}
\end{definition}

Note that this is equivalent to defining the norm of the operator $Q$ as follows:
\begin{equation}
  \|Q\|_{\{ V \rightarrow W_1,\ldots ,V \rightarrow W_n\} \text{ gen}} = \max \{ \|Q (v)\|_{\{ W_1,\ldots , W_n\} \text{ gen}}  \vert \hspace{1pt} \|v\|_{V} = 1 \}
\end{equation}
...
\begin{equation}
  \begin{split}
  \|Q\|_{1 \text{ gen}} & = \max  \Bigg\{ \max \left\{ \sum_{i=1}^{m} \|Q_{1i} (v_1)\|_{1}   \vert \hspace{1pt} \|v_1\|_{1} = 1 \right\} \\
  & \hspace{15pt} ,\hspace{2pt}  \ldots \hspace{2pt}  , \max \left\{ \sum_{i=1}^{m} \|Q_{ni} (v_n)\|_{1}   \vert \hspace{1pt} \|v_n\|_{1} = 1 \right\} \Bigg\} 
  \end{split}
\end{equation}
\end{definition}
...
\begin{equation}
  \begin{split}
    \|Q\|_{\diamondsuit \text{ gen}} & =  \max  \Bigg\{ \max \left\{ \sum_{i=1}^{m} \|Q_{1i} \otimes I_{\mathbb{C}^{o_1 \times o_1}} (v_1)\|_{1}    \vert \hspace{1pt} \|v_1\|_{1} = 1 \right\} \\
    & \hspace{15pt}, \hspace{2pt} \ldots \hspace{2pt}, \left\{ \sum_{i=1}^{m} \|Q_{ni} \otimes I_{\mathbb{C}^{o_n \times o_n}} (v_n)\|_{1}    \vert \hspace{1pt} \|v_n\|_{1} = 1 \right\} \Bigg\} 
  \end{split}
\end{equation}
\end{definition} 
