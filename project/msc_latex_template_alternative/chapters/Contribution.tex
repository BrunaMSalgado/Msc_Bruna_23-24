...
\begin{equation}
  \|Q\|_{1 \text{ gen}} = \max  \left\{ \max \left\{ \sum_{i=1}^{m} \|Q_{1i} (v)\|_{1}   \vert \hspace{1pt} \|v\|_{1} = 1 \right\}, \hspace{2pt} \ldots \hspace{2pt}, \left\{ \sum_{i=1}^{m} \|Q_{ni} (v)\|_{1}   \vert \hspace{1pt} \|v\|_{1} = 1 \right\} \right\} 
\end{equation}
\end{definition}
