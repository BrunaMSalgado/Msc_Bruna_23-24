...
For any vector spaces $V$, $W$, and $U$, $i: (V \otimes U) \oplus (W \otimes U) \xrightarrow{} (V  \oplus W) \otimes U $. If $V$ has dimension $m$, $W$ has dimension $n$ and $U$ has dimension $o$, then the space $(V \otimes U) \oplus (W \otimes U) $ has dimension $m+o$ [\cite{hefferon2006linear}]
...
\begin{split}
    ...
    \Leftrightarrow &  \hspace{2pt} ( [P,Q] \otimes I)  = [P \otimes I, Q \otimes I] \cdot  i^{-1}  &\text{\{\autoref{lem2}\}} \\
\end{split}
\end{equation}

\vspace{10pt}

With bla e bla it has been proven that the diagram bellow is valid:
\vspace{5pt}
