...
\todo[inline,size=\normalsize]{add more information about where the trace norm derives from (spectral theorem)}
...
\todo[inline,size=\normalsize]{add trace, partial trace, reduced density matrix, and respective Bloch Vector} %\label{eq:Bloch\_vector})}
