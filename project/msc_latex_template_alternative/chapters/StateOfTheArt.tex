...
\todo[inline]{Ver historia de reduções vs eqs}
...
\todo[inline,size=\normalsize]{Ver o que fazer com as cenas comentadas no fim, não esquecer esquema do quociente se incluir} 
...
As a part of our $\lambda$-theory we consider an operation $\text{dis}: \typeI \oplus \typeI \to \typeI$ which discards its input, accompanied by the following axiom
...
\left\{
    ...
    &\inr_{\typeI}(y) \Rightarrow   \text{ to} *. \,  \text{dis}(b) \text{ to} *. \inr_{\typeI}(*)  \\ 
  \end{aligned}  
  \right\}
\end{align*}
...
\left\{
    \begin{aligned} 
    &\inl_{\typeI}(x) \Rightarrow  \text{ to} *. \,  \text{dis}(b) \text{ to} *. \inl_{\typeI}(*) ; \\
...
The remaining properties can be proven through similar reasoning. 
