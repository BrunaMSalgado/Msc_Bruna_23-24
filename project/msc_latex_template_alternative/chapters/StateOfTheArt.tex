...
\begin{equation*}
  ...
  \end{split}
  \end{equation*}
Consider we can postulate the axiom $f^{\epsilon} =_{\epsilon} f$. Then, it is possible to show that $P^{\epsilon} =_{\epsilon} P $ using our metric equational system. The prove is as follows. The types and contexts are omitted for brevity as no ambiguity arises.
\begin{equation*}
  \begin{split}
  1 \hspace{10 pt} & f^{\epsilon} =_{\epsilon} f \\
