...
\end{equation}
 ...
 \end{definition}
  ...
  \begin{definition}\label{def:positive_superop_direct_sum}
...
\begin{equation*}
  \begin{split}
    ...
    = & [\![ \Gamma, x: \mathbb{D}  \triangleright \text{inl}_{\mathbb{B}}(v) :  \mathbb{A} \oplus \mathbb{B} ]\!] \cdot \text{jn}_{\Gamma;\mathbb{D}} \cdot (\text{id} \otimes [\![ \Delta \triangleright w:\mathbb{D}  ]\!]) \cdot \text{sp}_{\Gamma;\Delta}
  \end{split}
\end{equation*}
