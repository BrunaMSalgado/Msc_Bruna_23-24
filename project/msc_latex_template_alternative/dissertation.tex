...
\providecommand*{\conventionautorefname}{Remark}
...
\newacronym{miu}{miu}{Multiplicative involutive unital}
\newglossaryentry{ket}
{
    name=$\ket{\psi}$,
    description={Typical symbols for a quantum state. Also known as ket.}
}
\newglossaryentry{bra}
{
    name={$\bra{\psi}$},
    description={Typical symbol for $\ket{\psi}^{\dag}$. Also known as bra.}
}
...
{
    name={$\Gamma, \Delta, E$},
    description={Typical symbols for typing contexts.}
}
...
{
    name={$V, W, R$},
    description={Typical symbols for vector spaces.}
}
...
{
    name={$ \Gamma \vljud v =_{\epsilon} w$},
    description={Metric equation-in-context.}
}
...
{
    name={ $U$},
    description={ Typical designation for a unitary operator.}
}
...
\newglossaryentry{n-fold-oplus}
{
    name={ $(-)^{\oplus n}$},
    description={N-fold direct sum.}
}
...
{
    name={$d(v,w)$},
    description={distance between vectors $v$ and $w$. }
}
\newglossaryentry{mr}
{
...
{
    name={$  \mathscr{A}_1  \widehat{\otimes}_\pi \mathscr{A}_2 $},
    description={Projective tensor product of $ V $ and $ W $.}
}
\newglossaryentry{alg_tensor}
{
    name={$  V \odot W $},
    description={Algebraic tensor product of $ V $ and $ W $.}
}
\newglossaryentry{min_tensor}
{
    name={$  \mathscr{A}_1  \widecheck{\otimes} \mathscr{A}_2 $},
    description={ Spatial tensor product of $C^*$-algebras $\mathscr{A}_1$ and $\mathscr{A}_2$.}
}
\newglossaryentry{w*_tensor}
{
    name={$  \mathscr{M}  \overline{\otimes} \mathscr{N} $},
    description={$W^*$-algebras spatial tensor product of $W^*$-algebras $\mathscr{M}$ and $\mathscr{N}$.}
}
...
{
    name={$ \mathcal{H},  \mathcal{K}, \mathcal{L} $},
    description={Typical symbols for Hilbert spaces.}
}
...
\newglossaryentry{topological_dual_space}
{
    name={$ V^* $},
    description={ Topological dual space of $ V $}
}
\newglossaryentry{topological_dual_space_elem}
{
    name={$ v^* $},
    description={Element of the dual space \( V^* \) (considering $v \in V$).}
}
\newglossaryentry{field}
{
    name={$ \mathcal{F} $},
    description={Field of scalars of a vector space.}
}
\newglossaryentry{c*_alg}
{
    name={$\mathscr{A}, \mathscr{B}, \mathscr{C}, \ldots$},
    description={Typical symbols for C$^*$-algebras.}
}
\newglossaryentry{w*_alg}
{
    name={$\mathscr{M}, \mathscr{N}, \mathscr{T}$},
    description={Typical symbols for C$^*$-algebras.}
}
\newglossaryentry{pos_c*}
{
    name={$\mathscr{A}_+$},
    description={Set of positive elements of $\mathscr{A}$.}
}
\newglossaryentry{cb_norm}
{
    name={$\cbnorm{ \, \cdot \, }$},
    description={Completely bounded norm.}
}
\newglossaryentry{wcb_norm}
{
    name={$\wcbnorm{ \, \cdot \, }$},
    description={ $W^*$ Completely bounded norm.}
}
...
\titleB{quantum, probabilities and beyond}
\titleC{}
